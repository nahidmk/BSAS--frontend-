package bd.edu.seu.UI.BookingView;


import bd.edu.seu.UI.MainView;
import bd.edu.seu.backend.Model.Booking;
import bd.edu.seu.backend.Model.Bus;
import bd.edu.seu.backend.Service.BookingService;
import bd.edu.seu.backend.Service.BusService;
...
public class BookingList extends VerticalLayout {
    ...
    com.vaadin.flow.component.grid.Grid<Booking> Grid = new Grid<>(Booking.class);
